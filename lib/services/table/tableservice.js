...
TableService.prototype.getServiceStatsAsync = function (options)
{
      var self = this;

     return new Promise(function (resolve, reject) {
        self.listTablesSegmentedWithPrefix(options, function (error, serviceStatsResult, response) {
            if (error) {
                reject(error);
            } else {
                resolve([serviceStatsResult, response]);
            }
        }
            );
    });
...
TableService.prototype.listTablesSegmentedAsync = function (currentToken, options) {
 return this.listTablesSegmentedWithPrefixAsync(null /* prefix */, currentToken, options);
};
...
TableService.prototype.listTablesSegmentedWithPrefixAsync = function (prefix, currentToken, options)
{
      var self = this;

     return new Promise(function (resolve, reject) {
        self.listTablesSegmentedWithPrefix(prefix, currentToken, options, function (error, listTablesResult, response) {
            if (error) {
                reject(error);
            } else {
                resolve([listTablesResult, response]);
            }
        }
            );
    });
...
TableService.prototype.getTableAclAsync = function (table, options)
{
      var self = this;

     return new Promise(function (resolve, reject) {
        self.getTableAcl(table, options, function (error, tableResponse, response) {
            if (error) {
                reject(error);
            } else {
                resolve([tableResponse, response]);
            }
        }
            );
    });
...
TableService.prototype.setTableAclAsync = function (table, signedIdentifiers, options)
{
      var self = this;

     return new Promise(function (resolve, reject) {
        self.setTableAcl(table, signedIdentifiers, options, function (error, tableResponse, response) {
            if (error) {
                reject(error);
            } else {
                resolve([tableResponse, response]);
...
TableService.prototype.doesTableExistAsync = function (table, options) {
  return this._doesTableExistPromise(table, false, options);
};
...
TableService.prototype.createTableAsync = function (table, options)
{
      var self = this;

     return new Promise(function (resolve, reject) {
        self.createTable(table, options, function (error, tableResponse, response) {
            if (error) {
                reject(error);
            } else {
                resolve([tableResponse, response]);
...
TableService.prototype.createTableIfNotExistsAsync = function (table, options)
{
      var self = this;

     return new Promise(function (resolve, reject) {
        self.createTableIfNotExists(table, options, function (error, created, createdResponse) {
            if (error) {
                reject(error);
            } else {
                resolve([created, createdResponse]);
            }
        }
            );
    });
...
TableService.prototype.deleteTableAsync = function (table, options)
{
      var self = this;

     return new Promise(function (resolve, reject) {
        self.deleteTable(table, options, function (error, response) {
            if (error) {
                reject(error);
            } else {
                resolve([response]);
...
TableService.prototype.deleteTableIfExistsAsync = function (table, options)
{
      var self = this;

     return new Promise(function (resolve, reject) {
        self.deleteTableIfExists(table, options, function (error, deleted, response) {
            if (error) {
                reject(error);
            } else {
                resolve([deleted,response]);
            }
        }
            );
    });
...
TableService.prototype.queryEntitiesAsync = function (table, tableQuery, currentToken, options)
{
      var self = this;

     return new Promise(function (resolve, reject) {
        self.queryEntities(table, tableQuery, currentToken, options, function (error, queryResult, response) {
            if (error) {
                reject(error);
            } else {
...
TableService.prototype.retrieveEntityAsync = function (table, partitionKey, rowKey, options) {
  ...
  validate.validateArgs('retrieveEntity', function (v) {
    ...
    return this._performEntityOperationPromise(TableConstants.Operations.RETRIEVE,table,entityDescriptor, options);
};
...
TableService.prototype.insertEntityAsync = function (table, entityDescriptor,options) {
    return this._performEntityOperationPromise(TableConstants.Operations.INSERT,table,entityDescriptor, options);
};
...
TableService.prototype.insertOrReplaceEntityAsync = function (table, entityDescriptor,options) {
    return this._performEntityOperationPromise(TableConstants.Operations.INSERT_OR_REPLACE,table,entityDescriptor, options);
};
...
TableService.prototype.updateEntityAsync = function (table, entityDescriptor,options) {
    return this._performEntityOperationPromise(TableConstants.Operations.UPDATE,table,entityDescriptor, options);
};
...
TableService.prototype.mergeEntityAsync = function (table, entityDescriptor,options) {
    return this._performEntityOperationPromise(TableConstants.Operations.MERGE,table,entityDescriptor, options);
};
...
TableService.prototype.insertOrMergeEntityAsync = function (table, entityDescriptor,options) {
    return this._performEntityOperationPromise(TableConstants.Operations.INSERT_OR_MERGE,table,entityDescriptor, options);
};
...
TableService.prototype.deleteEntityAsync = function (table, entityDescriptor,options) {
    return this._performEntityOperationPromise(TableConstants.Operations.DELETE,table,entityDescriptor, options);
};
/**
...
TableService.prototype._doesTableExistPromise = function (table, primaryOnly, options) {
     var self = this;

     return new Promise(function (resolve, reject) {
        self._doesTableExist(table, primaryOnly, options, function (error, responseTableExists, response) {
            if (error) {
                reject(error);
            } else {
                resolve([responseTableExists,response]);
            }
        }
            );
    });
